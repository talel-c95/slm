      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-6 grid grid-cols-3 gap-8">
            <FooterColumn {...footerSections.product} />
            <FooterColumn {...footerSections.company} />
            <FooterColumn {...footerSections.support} />
          </div>
            ...
            <div className="space-y-3">
              {socialLinks.map((social, index) => (
                <button
                  ...
                  className="w-full flex items-center gap-2 text-gray-300 hover:text-white transition-colors group"
                >
